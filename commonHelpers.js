import"./assets/index-ea03cad6.js";import{g as f,a as l,r as w,L as u,h as S}from"./assets/exercises_card-60b901a7.js";import"./assets/vendor-ce9f25a7.js";const p=document.querySelector(".quote-text"),g=document.querySelector(".quote-author"),m="quote-info",r=JSON.parse(localStorage.getItem(m)),o={quote:"",author:"",date:0};r&&r.date!=new Date().getDate()?(p.textContent=r.quote,g.textContent=r.author,_()):(r&&(p.textContent=r.quote,g.textContent=r.author),_());function _(){f().then(t=>q(t)).catch(t=>console.log(t))}function q(t){o.quote=t.quote,o.author=t.author,o.date=new Date().getDate(),localStorage.setItem(m,JSON.stringify(o))}const i={cardSet:document.querySelector(".fav_card_list"),noCards:document.querySelector(".no_cards_wrapper")},y=t=>{const a=new Set;return t.filter(n=>a.has(n._id)?!1:(a.add(n._id),!0))},b=t=>{const e=y(t).map(({name:n,_id:s,burnedCalories:v,bodyPart:d,target:c})=>`<li data-id-card="${s}" data-component="fav_card" class="list_item">
          <div class="fav_card">
