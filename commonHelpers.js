import"./assets/index-ea03cad6.js";import{g as m,a as l,r as w,L as u,h as y}from"./assets/exercises_card-653cd5c0.js";import"./assets/vendor-ce9f25a7.js";const p=document.querySelector(".quote-text"),_=document.querySelector(".quote-author"),g="quote-info",r=JSON.parse(localStorage.getItem(g)),i={quote:"",author:"",date:0};r&&r.date!=new Date().getDate()?(p.textContent=r.quote,_.textContent=r.author,f()):(r&&(p.textContent=r.quote,_.textContent=r.author),f());function f(){m().then(t=>S(t)).catch(t=>console.log(t))}function S(t){i.quote=t.quote,i.author=t.author,i.date=new Date().getDate(),localStorage.setItem(g,JSON.stringify(i))}const o={cardSet:document.querySelector(".fav_card_list"),noCards:document.querySelector(".no_cards_wrapper")},q=t=>{const e=new Set;return t.filter(n=>e.has(n._id)?!1:(e.add(n._id),!0))},b=t=>{const a=q(t).map(({name:n,_id:s,burnedCalories:v,bodyPart:c,target:d})=>`<li data-id-card="${s}" data-component="fav_card" class="list_item">
          <div class="fav_card">
