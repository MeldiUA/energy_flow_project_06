import{g as f,a as o,s as S,r as w,L as i,h as q}from"./assets/exercises_card-3a89f3f7.js";import"./assets/vendor-ce9f25a7.js";const p=document.querySelector(".quote-text"),g=document.querySelector(".quote-author"),m="quote-info",r=JSON.parse(localStorage.getItem(m)),d={quote:"",author:"",date:0};r&&r.date!=new Date().getDate()?(p.textContent=r.quote,g.textContent=r.author,h()):(r&&(p.textContent=r.quote,g.textContent=r.author),h());function h(){f().then(t=>y(t)).catch(t=>console.log(t))}function y(t){d.quote=t.quote,d.author=t.author,d.date=new Date().getDate(),localStorage.setItem(m,JSON.stringify(d))}const l={cardSet:document.querySelector(".fav_card_list"),noCards:document.querySelector(".no_cards_wrapper")},b=t=>{const e=new Set;return t.filter(n=>e.has(n._id)?!1:(e.add(n._id),!0))},C=t=>{const a=b(t).map(({name:n,_id:s,burnedCalories:v,bodyPart:c,target:u})=>`<li data-id-card="${s}" data-component="fav_card" class="list_item">
          <div class="fav_card">
