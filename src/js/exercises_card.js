...
export default function handlerStartBtn(exercise, isFavourite = false) {
...
function renderModal(data) {
  ...
  document
    .querySelector('.add-favourite-btn')
    .addEventListener('click', function () {
      savedExercises.push(data);
      console.log(savedExercises);
      localStorage.setItem('favourite', JSON.stringify(savedExercises));
    });
